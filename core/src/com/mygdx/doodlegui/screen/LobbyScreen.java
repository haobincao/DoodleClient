...
public class LobbyScreen implements Screen {
	...
	Vector<String> existingPlayerNames; // also to be fetched from the server
	int maxPlayers = 5; // NO more than 6 please!
	boolean gotResponse = false;
	boolean startGame = false;
	boolean kick = false;

	public LobbyScreen(final DoodleDuelJump g, String rc, Vector<String> pn) {
		this.game = g;
		this.game.screenID = 9;
		this.game.connection.lobbyScreen = this;
	...
	public void show() {
		...
		// does existing player names include the new player? I'm going to assume not.
		for (String pn : existingPlayerNames) {
			Label newLab = new Label(pn, playls);
			newLab.setWrap(true);
		...
		sendMessage.addListener(new InputListener() {
			...
			public void touchUp(InputEvent event, float x, float y, int pointer, int button) {
				...
				if (message != "" && !message.matches("[ ]+")) {
					// addChatMessage(game.getUsername(), message);
	...
	public void render(float delta) {
		...
		// String newUser = "someGuyg22";
		// playerNames.add(newUser);
		// addNewPlayer(newUser);
		// }
	}
